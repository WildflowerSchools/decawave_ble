...
logging.info('Getting data from Decawave devices (before configuration)')
...
# Get data from Decawave devices and write files
logging.info('Getting data from Decawave devices (after new configuration)')
...
logging.info('Restoring baseline from database')
configure_devices.configure_devices_from_database(ConfigurationDatabaseCSVLocal(baseline_config_database_path))

# Get data from Decawave devices and write files
logging.info('Getting data from Decawave devices (after restoration)')
